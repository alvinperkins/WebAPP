...
import sys, cgi, http.cookies, pprint, urllib.parse, urllib
from web.utils import storage, storify, threadeddict, dictadd, intget, safestr, safeunicode
...
def header(hdr, value, unique=False):
    ...
    """
    hdr, value = safeunicode(hdr), safeunicode(value)
...
def setcookie(name, value, expires='', domain=None,
    ...
    name, value = safeunicode(name), safeunicode(value)
